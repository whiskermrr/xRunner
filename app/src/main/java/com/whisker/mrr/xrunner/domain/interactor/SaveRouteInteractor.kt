...
class SaveRouteInteractor(transformer: CompletableTransformer, private val routeRepository: RouteRepository)
: CompletableUseCase(transformer) {
    ...
    override fun createCompletable(data: Map<String, Any>?): Completable {
        ...
        routeEntity?.let {
            return routeRepository.saveRoute(routeEntity as RouteEntity)
